...
public class IndustrialFragment extends Fragment {
     ...
     * @return A new instance of fragment IndustrialFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_industrial, container, false);
        WebView mywebview = (WebView) root.findViewById(R.id.webViewindustrial);
        mywebview.loadUrl("https://rvce.edu.in//iem-menu");
        return root;
    }
}
