...
public class MechanicalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_mechanical, container, false);
        WebView mywebview = (WebView) root.findViewById(R.id.webViewmechanical);
        mywebview.loadUrl("https://rvce.edu.in//me-menu");
        return root;
    }
}
