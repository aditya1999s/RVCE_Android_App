...
public class ChemicalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_chemical, container, false);
        WebView mywebview = (WebView) root.findViewById(R.id.webViewchemical);
        mywebview.loadUrl("https://rvce.edu.in//ch-menu");
        return root;
    }
}
